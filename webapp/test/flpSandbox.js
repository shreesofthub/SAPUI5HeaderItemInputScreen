		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Add Delete &amp; Save Multiple Records in SAPUI5.",
									"targetURL": "#AddDelete&amp;SaveMultipleRecordsinSAPUI5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"AddDelete&amp;SaveMultipleRecordsinSAPUI5-display": {
								"semanticObject": "AddDelete&amp;SaveMultipleRecordsinSAPUI5",
								"action": "display",
								"description": "Add Delete &amp; Save Multiple Records in SAPUI5",
								"title": "Add Delete &amp; Save Multiple Records in SAPUI5.",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=yard.sapyard11",
									"url": sap.ui.require.toUrl("yard/sapyard11")
								}
							}
						}
					}
